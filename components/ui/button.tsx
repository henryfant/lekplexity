  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        green: "h-9 px-4 rounded-[10px] text-sm font-medium items-center transition-all duration-200 disabled:cursor-not-allowed disabled:opacity-50 bg-green-600 text-white hover:bg-green-500 dark:bg-green-600 dark:hover:bg-green-500 dark:text-white [box-shadow:inset_0px_-2.108433723449707px_0px_0px_#166534,_0px_1.2048193216323853px_6.325301647186279px_0px_rgba(34,_197,_94,_58%)] hover:translate-y-[1px] hover:scale-[0.98] hover:[box-shadow:inset_0px_-1px_0px_0px_#166534,_0px_1px_3px_0px_rgba(34,_197,_94,_40%)] active:translate-y-[2px] active:scale-[0.97] active:[box-shadow:inset_0px_1px_1px_0px_#166534,_0px_1px_2px_0px_rgba(34,_197,_94,_30%)] disabled:shadow-none disabled:hover:translate-y-0 disabled:hover:scale-100",
      },
      size: {
